var nameList=['实时热点','七日热点','今日热点'];
var datas={"七日热点":{},"今日热点":{},"实时热点":{}};
...
setInterval(()=>{
	var url='http://skyzhou.top:8023/jspy_send';
	var formData = new FormData();
	formData.append("Send_data", JSON.stringify(datas));
	formData.append("Send_rank", result);
